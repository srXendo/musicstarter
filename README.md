...
🎧 Real-time music synchronization across all browsers in the same room

🏠 Create and join rooms to share music sessions

💻 Angular frontend with a modern UI
...
Backend: Node.js (v20.19.4)

Real-time communication: http2
